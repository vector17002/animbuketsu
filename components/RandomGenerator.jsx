...
const RandomGenerator = () => {
  ...
  return (
    <div className='w-[100vw] lg:h-[400px] h-full mt-5 m-10 bg-transparent'>
      <div className='w-full h-full lg:backdrop-blur-lg lg:bg-white/30 flex items-center justify-evenly lg:flex-row flex-col'>
        <div className='h-full w-50 flex flex-col justify-center items-center m-4'>
          ...
          <button type='button' onClick={handleGetRandom} className='p-2 bg-indigo-400 text-white rounded-xl hover:bg-white hover:text-purple-400 m-3'>Generate</button>
        </div>
